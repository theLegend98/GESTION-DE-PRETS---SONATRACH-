			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="POST" action="{{ route('password.update') }}"">
					...
					<div class="wrap-input100 validate-input" data-validate = "L'adresse e-mail valide est: a@b.c">
						<input class="input100 " type="text" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
					...
					<div class="wrap-input100 validate-input" data-validate="Enterer mot de passe">
						<span class="btn-show-pass">
							<i class="zmdi zmdi-eye"></i>
						</span>
						<input class="input100" type="password" name="password" required autocomplete="Nouveau mot de passe">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enterer mot de passe">
						...
						<input class="input100" type="password" name="password_confirmation" required autocomplete="Nouveau mot de passe">
