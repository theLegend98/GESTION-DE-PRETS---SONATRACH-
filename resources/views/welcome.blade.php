...
<html>
	...
	<body>
		...
		<!-- Header -->
			<header id="header">
				<div class="inner">
					<a href="#" class="logo"><strong>SONATRACH </strong>Gestion de prêts </a>
					<nav id="nav">
						<a href="">Accueil</a>
						<a href="">Contacts</a>
		...
		<!-- Banner -->
			<section id="banner"   >
				<div class="inner">
					<header>
						<h1>Bienvenue</h1>
						<h2 style="color: beige;">Application de gestion de prêts - <strong style="color: beige;">SONATRACH</strong></h2>
					</header>
					...
					<div class="flex ">
						...
						<div>
							...
							<h3>Demande de prêts</h3>
							<p>Faite votre propre demande de prêt</p>
						</div>

						<div>
							<span class="icon fa-eye"></span>
							<h3>Suivi de la demande</h3>
							<p>Suivre votre demande de prêt en temps réel</p>
						</div>

						<div>
							<span class="icon fa-list-alt"></span>
							<h3>Suivi des prêts</h3>
							<p>Consulter vos prêts en cours</p>
						</div>
		...
		<!-- Scripts -->
			...
			<script src="{{ asset('assetsHome/js/skel.min.js') }}"></script>
			<script src="{{ asset('assetsHome/js/util.js') }}"></script>
