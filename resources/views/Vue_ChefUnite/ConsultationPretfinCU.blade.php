    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Liste des Prêts au niveau du département {{$prets[0]->nomdep}}</h3>
                      ...
                      <tr>
                        <td>
                          ...
                          <td>
                            ...
                            <button type="button" class="btn btn-default" data-toggle="modal" data-id="{{ json_encode($pret) }}" data-target="#exampleModalLong">
