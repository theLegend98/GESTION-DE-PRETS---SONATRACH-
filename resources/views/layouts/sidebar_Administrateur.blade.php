      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item" style=" margin-bottom: 2.5%; ">
            <a href="{{ url('ADMINISTRATEUR') }}" class="nav-link @if(Request::url() === 'http://127.0.0.1:8000/ADMINISTRATEUR'))
            active
      @endif">
            ...
            <a href="{{ url('ProfilAdministrateur') }}" class="nav-link @if(Request::url() === 'http://127.0.0.1:8000/ProfilAdministrateur'))
            active
      @endif">
          ...
          <li class="nav-item" style=" margin-bottom: 2.5%; margin-top:2.5%; ">
           ...
           <a href="{{ url('ConsultationPretADM') }}" class="nav-link @if(Request::url() === 'http://127.0.0.1:8000/ConsultationPretADM' )
            active
      @endif">
           ...
           <a href="{{ url('ConsultationPretfinADM') }}" class="nav-link @if(Request::url() === 'http://127.0.0.1:8000/ConsultationPretfinADM' )
            active
      @endif">
