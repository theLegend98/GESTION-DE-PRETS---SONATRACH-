      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item" style=" margin-bottom: 2.5%; ">
            <a href="{{ url('CHEFUNITE') }}" class="nav-link @if(Request::url() === 'http://127.0.0.1:8000/CHEFUNITE'))
            active
      @endif">
          ...
          <li class="nav-item" style=" margin-bottom: 2.5%; margin-top:2.5%; ">
            <a href="{{ url('ProfilChefunite') }}" class="nav-link @if(Request::url() === 'http://127.0.0.1:8000/ProfilChefunite'))
            active
      @endif">
           ...
           <a href="{{ url('ConsultationPretCU') }}" class="nav-link @if(Request::url() === 'http://127.0.0.1:8000/ConsultationPretCU' )
            active
      @endif">
           ...
           <a href="{{ url('ConsultationPretfinCU') }}" class="nav-link @if(Request::url() === 'http://127.0.0.1:8000/ConsultationPretfinCU' )
            active
      @endif">
