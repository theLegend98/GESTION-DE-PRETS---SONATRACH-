        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Modifier agent</li>
                ...
                <form role="form" action="{{ route('Agent.update', $agent->id) }}" method="POST">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nom" placeholder="Nom" name="nom" value={{ $agent->nom }} required>
                      </div>
                      <div class="form-group">
                        <label for="prenom">Prenom</label>
                        <input type="text" class="form-control" id="Prenom" placeholder="Prenom" name="prenom" value={{ $agent->prenom }} required>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="date" class="form-control float-right"  placeholder="Date de naissance" name="ddn" value={{ $agent->ddn }} required>
                        </div>
                        <!-- /.input group -->
                      </div>
                      <div class="form-group">
                        <label for="tel">N° telephone</label>
                        <input type="tel" class="form-control" id="tel"  pattern="[0]{1}[0-9]{9}" name="tel"  value={{ $agent->tel }} placeholder="N°telephone">
                      </div>
                      <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="texte" class="form-control" id="Poste" placeholder="Poste" name="statut"  value={{ $agent->statut }} required>
                      </div>
