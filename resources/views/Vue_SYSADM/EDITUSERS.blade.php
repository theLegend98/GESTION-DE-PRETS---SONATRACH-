...
@if(session()->has('message'))
    ...
    @if ( session()->get('message')== "Utilisateur Modifié")
                ...
                <form role="form" action="{{ route('User.update', $user->id) }}" method="POST">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nom" placeholder="Pseudo" name="name" value={{ $user->name }} required>
                    </div>
                    <div class="form-group">
                        <label>Type</label>
                        <select class="form-control"  name="type">
                          ...
                          <option value="SYSADM">ADMINISTRATEUR SYSTEME</option>
                        </select>
                    </div>
                    <div class="form-group">
